...
export default function Footer() {
  ...
  function copyToClipboard(text: string, field: CopyField) {
  ...
  return (
    <footer id="contact" className="bg-[#0e1a20] text-white w-full shadow-inner mt-20">
            ...
            {copyMessage.field === "email" && (
              <span
                className={`ml-2 text-sm ${
                  copyMessage.status === "success" ? "text-green-400" : "text-red-400"
                }`}
              >
